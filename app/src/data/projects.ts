...
export const reactProjects: Project[] = [
  {
    ...
    images: [
      { src: "./public/react/first-project/page-1.png", alt: "맛집화면1" },
      { src: "./public/react/first-project/page-2.png", alt: "맛집화면2" },
      { src: "./public/react/first-project/page-3.png", alt: "맛집화면3" },
      { src: "./public/react/first-project/page-4.png", alt: "맛집화면4" },
      { src: "./public/react/first-project/page-5.png", alt: "맛집화면5" },
    ],
